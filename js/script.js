...
(function (global) {
  ...
  var switchToActive = function (snippet) {
    ...
    removeActive("#navHomeButton");
    removeActive("#navMenuButton");
    removeActive("#navAboutButton");
    removeActive("#navAwardsButton");
    if (snippet=="Menu") {
